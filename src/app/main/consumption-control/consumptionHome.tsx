    ...
    <SafeAreaView style={styles.container} edges={["bottom"]}>
      ...
      <View style={styles.main}>
        <View style={styles.modulesList}>
          <View>
            <PermissionWrapper requiredPermissions={[39, 7]} mode="ALL">
              <TouchableOpacity
                onPress={() => {
            ...
            <PermissionWrapper requiredPermissions={[42]}>
              <TouchableOpacity
                onPress={() => {
            ...
            <PermissionWrapper requiredPermissions={[38]}>
              <TouchableOpacity
                onPress={() => {
            ...
            <PermissionWrapper requiredPermissions={[34]}>
              <TouchableOpacity
                onPress={() => {
