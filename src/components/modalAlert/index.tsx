...
import { Modal, ModalProps, Text, TouchableOpacity, View, useColorScheme } from "react-native";
...
export default function ModalAlert({ iconColor = Colors.red, IconCenter, title, iconCenterName, text, buttonPress, ...rest }: Props) {
